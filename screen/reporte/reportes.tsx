...
export default function ReportesScreen() {
  ...
  const esAdmin =
    userRol?.toLowerCase() === "admin" ||
    userRol?.toLowerCase() === "administrador";
  const {
    metrics,
    interesProspectos,
  ...
  const seguimientosFiltrados = seguimientos?.filter((s: any) => {
    ...
    const passEstado = filtroEstado
      ? s.estadoSeguimientoReal === filtroEstado
      : true;
  ...
  const conteoPorEstado = seguimientos?.reduce(
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F8F7FF" }}>
      ...
      >
        ...
        >
          <View>
            <Text style={{ fontSize: 20, fontWeight: "800", color: "#1E0A3C" }}>
              Reportes
            </Text>
            <Text style={{ fontSize: 12, color: "#9CA3AF", marginTop: 1 }}>
              Reportes varios del sistema.
            </Text>
          </View>
          <Pressable
          ...
          {esAdmin && (
            <View style={{ flexDirection: "row", gap: 12, marginBottom: 12 }}>
              ...
              <View style={[styles.metricCard, { backgroundColor: "#E1007E" }]}>
                ...
                <Text
                  style={[styles.metricSub, { color: "rgba(255,255,255,0.6)" }]}
                >
                  Basado en adelantos
                </Text>
              </View>
          ...
          <View style={styles.sectionCard}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={{ flexDirection: "row", gap: 10 }}>
                ...
                {/* Chips de Estado */}
                {Object.entries(conteoPorEstado ?? {}).map(
                  ([estado, count], i) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.estadoChip,
                          isSelected && {
                            borderColor: ESTADO_COLORS[estado] ?? "#E1007E",
                            borderWidth: 2,
                            backgroundColor: "#FDF2F8",
                          },
                        ]}
                        ...
                        >
                          ...
                          <Text
                            style={{
                              fontSize: 10,
                              fontWeight: "700",
                              color: ESTADO_COLORS[estado] ?? "#E1007E",
                              textTransform: "uppercase",
                            }}
                          >
                            {estado}
          ...
          <View style={styles.sectionCard}>
            ...
            >
              ...
              >
                ...
                >
                  {seguimientosFiltrados?.length ?? 0} total
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={{ minWidth: 720 }}>
                ...
                {(mostrarTodosSeguimientos
                  ...
                  : seguimientosFiltrados?.slice(0, 5)
                )?.map((s: any, i: number) => (
                  <TouchableOpacity
                    key={s.id}
                  ...
                  >
                    ...
                    {esAdmin ? (
                      ...
                      <View style={{ width: 90 }}>
                        <View
                          style={{
                            backgroundColor:
                              INTERES_COLORS[s.nivelInteres] + "20",
                            borderRadius: 20,
                            paddingHorizontal: 8,
                            paddingVertical: 4,
                            alignSelf: "flex-start",
                        ...
                        >
                          <Text
                            style={{
                              fontSize: 10,
                              fontWeight: "700",
                              color: INTERES_COLORS[s.nivelInteres],
                            }}
                          >
                            {s.nivelInteres}
                          </Text>
                    ...
                    <Text
                      style={{
                        ...
                        fontSize: 12,
                        fontWeight: "600",
                        color: s.adelanto > 0 ? "#10B981" : "#9CA3AF",
                      }}
                    >
                      {s.adelanto > 0
            ...
            {(seguimientosFiltrados?.length ?? 0) > 5 && (
              <TouchableOpacity
                onPress={() =>
                  setMostrarTodosSeguimientos(!mostrarTodosSeguimientos)
                }
                style={{
                  marginTop: 12,
                  paddingVertical: 10,
              ...
              >
                ...
                >
                  {mostrarTodosSeguimientos
                    ? "Ver menos"
                    : `Ver más (${(seguimientosFiltrados?.length ?? 0) - 5} más)`}
                </Text>
              ...
              <View style={[styles.sectionCard, { flex: 1 }]}>
                ...
                {Object.entries(INTERES_COLORS).map(([nivel, color]) => (
                  ...
                  >
                    ...
                    >
                      {interesProspectos?.porcentajes?.[
                        nivel as "Alto" | "Medio" | "Bajo"
                      ] ?? 0}
                      %
                    </Text>
                  </View>
          ...
          <View style={styles.sectionCard}>
            ...
            >
              <View style={{ flex: 1, marginRight: 8 }}>
                ...
                <Text style={{ fontSize: 11, color: "#9CA3AF" }}>
                  Desempeño del período seleccionado
                </Text>
              </View>
              <View
                style={{
              ...
              >
                ...
                <Text
                  style={{ fontSize: 11, color: "#E1007E", fontWeight: "600" }}
                >
                  Top 5
                </Text>
              </View>
  ...
  return (
    ...
    >
      ...
      <View style={{ alignItems: "center" }}>
        <Text style={{ fontSize: 18, fontWeight: "800", color: "#1E0A3C" }}>
